...
<img src="https://render.githubusercontent.com/render/math?math=y = 0.1S_1 \text{ + } 0.1S_2 \+ 0.1S_3 \+ 0.1S_4 \+ 0.1S_5 \+ 0.1S_6 \+ 0.1S_7 \+ 0.1S_8 \+ 0.1S_9 \+ 0.1S_10 \+ \epsilon, \epsilon ~ N(\mu = 0, \sigma = 0.5*E[y])">
