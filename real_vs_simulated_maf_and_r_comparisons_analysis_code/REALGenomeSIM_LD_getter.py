...
from REALGenomeSIM_LD_cgetter import open_LD_file
from REALGenomeSIM_LD_cgetter import binner
...
# example:
# python triadsim_LD_getter.py --ref all_1000_genomes_GBR_processed --sim all_1000_genomes_GBR_simulated
...
plots[1].plot(unique_mafs_reference, unique_mafs_simulated, '.k', label = "real vs simulated mafs for " + (args.ref_fname)[17:20] + " subpopulation")
...
plots[0].set_title("real versus simulated r values \n for " + (args.ref_fname)[17:20] + " subpopulation")
plots[1].set_title("real versus simulated mafs \n for " + (args.ref_fname)[17:20] + " subpopulation")
fig.savefig("real_vs_sim_r_val_maf_comparision_"+ (args.ref_fname)[17:20] + ".png")
fig.clf()
...
fig, plots = plt.subplots(1, 2, figsize = (16, 7))
plots[0].plot(unique_distances2, average_LD_per_distance2_reference, '.', label = "average absolute r vs distance for real" + (args.ref_fname)[17:20])
plots[1].plot(unique_distances2, average_LD_per_distance2_simulated, '.', label = "average absolute r vs distance for simulated " + (args.ref_fname)[17:20])
...
plots[0].set_title("absolute r versus distance \n for real " + (args.ref_fname)[17:20] + " subpopulation")
plots[1].set_title("absolute r versus distance \n for simulated " + (args.ref_fname)[17:20] + " subpopulation")
fig.savefig("real_vs_sim_r_vs_distance_profile_comparison_"+ (args.ref_fname)[17:20] + ".png")
fig.clf()